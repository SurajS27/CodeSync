...
class UserBase(BaseModel):
    ...
    github_email: str | None = Field(None, max_length=255, description="Primary email address on GitHub")
    github_avatar_url: AnyHttpUrl | None = Field(None, description="GitHub user profile avatar URL")
