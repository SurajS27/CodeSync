...
class GitHubLoginResponse(BaseModel):
    ...
    authorization_url: str = Field(..., description="Target GitHub OAuth redirection URL")
...
class AuthenticatedUserResponse(BaseModel):
    ...
    user: UserResponse = Field(..., description="Profile information for the authenticated User")
