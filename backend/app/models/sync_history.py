...
from sqlalchemy import DateTime, Enum as SQLEnum, ForeignKey, String, Text, UniqueConstraint, Uuid
...
class SyncHistory(Base):
    ...
    sync_status: Mapped[SyncStatus] = mapped_column(
        SQLEnum(SyncStatus, name="syncstatus", values_callable=lambda x: [e.value for e in x], create_type=False),
        default=SyncStatus.PENDING,
        nullable=False,
        index=True
    )

    github_file_path: Mapped[str | None] = mapped_column(
        Text,
        nullable=True
    )
