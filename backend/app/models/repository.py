...
from sqlalchemy import BigInteger, Boolean, DateTime, Enum as SQLEnum, ForeignKey, String, Text, UniqueConstraint, Uuid
...
class Repository(Base):
    ...
    owner_github_username: Mapped[str] = mapped_column(
        String(255),
        nullable=False
    )
    ...
    bootstrap_version: Mapped[str | None] = mapped_column(
        String(50),
        nullable=True
    )
    ...
    bootstrap_error: Mapped[str | None] = mapped_column(
        Text,
        nullable=True
    )
